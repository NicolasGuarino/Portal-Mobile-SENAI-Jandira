...
public class CustomAdapter extends PagerAdapter {
    ...
    private int[] imgs = {R.drawable.tvdigital,R.drawable.code, R.drawable.vagas};
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if(position == 0){
            tv.setText("Alunos SENAI ajudam população a receber sinal digital de TV");
        }else if(position == 1){
            tv.setText("Alunos do SENAI Jandira desenvolvem APP inovador!");
        }else if(position == 2){
            tv.setText("SENAI abre inscrições para cursos gratuitos de aprendiz industrial");
        }
